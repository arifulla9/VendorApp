...
<h1 style="color:Tomato;">welcome to Location Register Page!!</h1>
<h1 style="border: 2px solid DodgerBlue;">welcome to Location Register Page!!</h1>
<h1 style="background-color:Tomato;">welcome to Location Register Page!!</h1>
